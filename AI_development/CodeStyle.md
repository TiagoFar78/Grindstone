...
- For unit tests, the test class name should be the name of the class with "Test" suffix.
- For unit tests names use the following: <method name>_<action>_<expected result>
